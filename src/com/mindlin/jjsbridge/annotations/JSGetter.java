...
/**
 * Marks a function as a property getter. Note that the field does not actually have to be declared in the
 * Java code, as they can be virtually generated.<br/>
 * <h3>Virtual Fields</h3>
 * If you using this to generate a virtual field from a getter, then you should also annotate the getter
